...
class Main(BasePDF):
    ...
    def __init__(self, instream, outstream):
        ...
        f.fields = ({
            ...
            'language_j_reading': f.circle({5: (168, 706), 4: (186, 706), 3: (202, 706), 2: (220, 706), 1: (237, 706)}),
            'language_j_writing': f.circle({5: (260, 706), 4: (278, 706), 3: (295, 706), 2: (311, 706), 1: (330, 706)}),
            'language_j_listening': f.circle({5: (355, 706), 4: (371, 706), 3: (387, 706), 2: (403, 706), 1: (421, 706)}),
            'language_j_speaking': f.circle({5: (445, 706), 4: (461, 706), 3: (476, 706), 2: (494, 706), 1: (512, 706)}),
            'language_e_reading': f.circle({5: (168, 682), 4: (186, 682), 3: (202, 682), 2: (220, 682), 1: (237, 682)}),
            'language_e_writing': f.circle({5: (260, 682), 4: (278, 682), 3: (295, 682), 2: (311, 682), 1: (330, 682)}),
            'language_e_listening': f.circle({5: (355, 682), 4: (371, 682), 3: (387, 682), 2: (403, 682), 1: (421, 682)}),
            'language_e_speaking': f.circle({5: (445, 682), 4: (461, 682), 3: (476, 682), 2: (494, 682), 1: (512, 682)}),
            'language_o_name': f.shortans((110, 655)),
            'language_o_reading': f.circle({5: (168, 660), 4: (186, 660), 3: (202, 660), 2: (220, 660), 1: (237, 660)}),
            'language_o_writing': f.circle({5: (260, 660), 4: (278, 660), 3: (295, 660), 2: (311, 660), 1: (330, 660)}),
            'language_o_listening': f.circle({5: (355, 660), 4: (371, 660), 3: (387, 660), 2: (403, 660), 1: (421, 660)}),
            'language_o_speaking': f.circle({5: (445, 660), 4: (461, 660), 3: (476, 660), 2: (494, 660), 1: (512, 660)}),
